...
func listDomainRecords(client *alidns.Client, domain string) []string {
...
func main() {
	...
	case "authenticator":
		...
		addDomainRecord(client, domain, domainName, value)
	...
	case "cleanup":
		...
		recordIds := listDomainRecords(client, domain)
